...
- **Authentication is not authorization.** Knowing _who_ the caller is says nothing about whether
  they may touch _this_ record. Every new endpoint, handler, resolver, job and RPC needs both.
